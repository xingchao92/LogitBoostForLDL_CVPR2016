function  [] = drawdistribution(testDistribution,prediction,dist)
...
%
h=figure('Position',[330, 20, 800, 620]);
...
% Draw the table.
cnames = {'kldist','eculideandist','sorensendist','squaredxdist','fidelity','intersection'};
rnames = {'value'};
uitable('Parent',h,'Data',dist','ColumnName',cnames,... 
            'RowName',rnames,'Position',[135, 60, 555, 42]);